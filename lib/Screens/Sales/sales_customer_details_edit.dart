...
class SalesCustomerDetailsEditScreen extends StatefulWidget {
  const SalesCustomerDetailsEditScreen({Key? key}) : super(key: key);

  @override
  _SalesCustomerDetailsEditScreenState createState() => _SalesCustomerDetailsEditScreenState();
}

class _SalesCustomerDetailsEditScreenState extends State<SalesCustomerDetailsEditScreen> {
  ...
  String area = "Pallabi";
  String email = "shihab@gmail.com";
  String whatsapp = "01919200100";
  String imo = "01919200100";
  String nidNo = "1027142589";
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.white,
      appBar: AppBar(
        ...
        title: const Text("Customer details ",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400),),
