...
class SalesAddGuarantorScreen extends StatefulWidget {
  const SalesAddGuarantorScreen({Key? key}) : super(key: key);

  @override
  _SalesAddGuarantorScreenState createState() => _SalesAddGuarantorScreenState();
}

class _SalesAddGuarantorScreenState extends State<SalesAddGuarantorScreen> {
