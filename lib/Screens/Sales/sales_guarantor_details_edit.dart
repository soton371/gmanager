...
class SalesGuarantorDetailsEditScreen extends StatefulWidget {
  const SalesGuarantorDetailsEditScreen({Key? key}) : super(key: key);

  @override
  _SalesGuarantorDetailsEditScreenState createState() => _SalesGuarantorDetailsEditScreenState();
}

class _SalesGuarantorDetailsEditScreenState extends State<SalesGuarantorDetailsEditScreen> {

  bool selectReadOnly = true;
  String name = "Jamal Uddin";
  String address = "Pallabi, Dhaka-1216";
  String mobile = "01919240104";
  String relation = "Uncle";
  String email = "jamal@gmail.com";
  String whatsapp = "01919240104";
  String imo = "01919240104";
  String nidNo = "1027147895";
  ...
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.white,
      appBar: AppBar(
        ...
        title: const Text("Guarantor details-1 ",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400),),
