...
class SupplierLedgerDetails extends StatefulWidget {
  const SupplierLedgerDetails({Key? key}) : super(key: key);

  @override
  _SupplierLedgerDetailsState createState() => _SupplierLedgerDetailsState();
}

class _SupplierLedgerDetailsState extends State<SupplierLedgerDetails> {
  @override
